(function ($) {
        ...
        initSlick: function(element) {
            ...
            element.each( function(){
                var config = {
                    ...
                    slidesToShow: 4,
                    slidesToScroll: 4,
                    prevArrow:"<button type='button' class='slick-arrow slick-prev'><i class='ti-angle-left' aria-hidden='true'></i></span><span class='textnav'>"+ workio_ajax.previous +"</span></button>",
                    nextArrow:"<button type='button' class='slick-arrow slick-next'><span class='textnav'>"+ workio_ajax.next +"</span><i class='ti-angle-right' aria-hidden='true'></i></button>",
                };
    ...
    jQuery(window).on("elementor/frontend/init", function() {
        ...
        elementorFrontend.hooks.addAction( "frontend/element_ready/apus_element_jobs_packages.default",
            function($scope) {
                apusthemecore_init.initSlick($scope.find('.slick-carousel'));
            }
        );
