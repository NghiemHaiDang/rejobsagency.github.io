...
?>
<div class="widget-filter-job-top widget-filter-top">
	<div class="container">
		<?php 
		...
		<form method="get" action="<?php echo WP_Job_Board_Mixes::get_jobs_page_url(); ?>" class="filter-job-form filter-listing-form filter-job-top">
			<?php $fields = $fields_adv = workio_job_get_filter_fields(); ?>
						...
						<div class="flex-middle space-bottom-15">
							<?php if ( ! empty( $instance['button_text'] ) ) : ?>
								<div class="visiable-line">
									<button class="button btn btn-theme-second">Bộ lọc</button>
								</div><!-- /.form-group -->
							<?php endif; ?>
