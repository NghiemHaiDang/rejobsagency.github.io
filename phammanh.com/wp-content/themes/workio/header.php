...
<body <?php body_class(); ?>>
<?php if ( workio_get_config('preload', true) ) {
	$preload_icon = workio_get_config('media-preload-icon');
...
<div id="wrapper-container" class="wrapper-container">
	...
	<?php
		$header = apply_filters( 'workio_get_header_layout', workio_get_config('header_type') );
		if ( !empty($header) ) {
			workio_display_header_builder($header);
		} else {
