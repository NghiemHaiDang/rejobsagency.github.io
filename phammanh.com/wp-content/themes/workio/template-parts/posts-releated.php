<?php
    $relate_count = workio_get_config('number_blog_releated', 2);
    $relate_columns = workio_get_config('releated_blog_columns', 2);
...
<div class="related-posts">
    <h4 class="title">
        <span><?php esc_html_e( 'Related Posts', 'workio' ); ?></span>
    </h4>
