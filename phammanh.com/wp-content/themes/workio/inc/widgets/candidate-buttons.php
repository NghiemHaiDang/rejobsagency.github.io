...
class Workio_Widget_Candidate_Buttons extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_candidate_buttons',
            esc_html__('Candidate Detail:: Candidate Buttons', 'workio'),
            array( 'description' => esc_html__( 'Show candidate buttons', 'workio' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('show_shortlist_button') ); ?>">
                <?php esc_html_e('Show Shortlist Button', 'workio'); ?>
            </label>
        </p>
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('show_cv_button') ); ?>">
                <?php esc_html_e('Show Download CV Button', 'workio'); ?>
            </label>
        </p>
<?php
    }
    ...
    public function update( $new_instance, $old_instance ) {
        ...
        $instance['show_shortlist_button'] = (isset( $new_instance['show_shortlist_button'] ) ) ? $new_instance['show_shortlist_button'] : '';
        $instance['show_cv_button'] = (isset( $new_instance['show_cv_button'] ) ) ? $new_instance['show_cv_button'] : '';
        return $instance;
    }
}
if ( function_exists('apus_framework_reg_widget') ) {
    apus_framework_reg_widget('Workio_Widget_Candidate_Buttons');
}