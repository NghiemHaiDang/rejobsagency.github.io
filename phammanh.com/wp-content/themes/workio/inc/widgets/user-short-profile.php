...
class Workio_Widget_User_Short_Profile extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_user_short_profile',
            esc_html__('Apus User Short Profile', 'workio'),
            array( 'description' => esc_html__( 'Show User Short Profile in sidebar', 'workio' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $custom_menus = array( '' => esc_html__('Choose a menu', 'workio') );
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('nav_menu_employer')); ?>">
                <?php echo esc_html__('Employer Menu:', 'workio' ); ?>
            </label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('nav_menu_candidate')); ?>">
                <?php echo esc_html__('Candidate Menu:', 'workio' ); ?>
            </label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('nav_menu_employee')); ?>">
                <?php echo esc_html__('Employee Menu:', 'workup' ); ?>
            </label>
            <br>
...
<?php
    ...
    public function update( $new_instance, $old_instance ) {
        ...
        $instance['nav_menu_employer'] = ( ! empty( $new_instance['nav_menu_employer'] ) ) ? $new_instance['nav_menu_employer'] : '';
        $instance['nav_menu_candidate'] = ( ! empty( $new_instance['nav_menu_candidate'] ) ) ? $new_instance['nav_menu_candidate'] : '';
        $instance['nav_menu_employee'] = ( ! empty( $new_instance['nav_menu_employee'] ) ) ? $new_instance['nav_menu_employee'] : '';
        return $instance;
    }
}
if ( function_exists('apus_framework_reg_widget') ) {
    apus_framework_reg_widget('Workio_Widget_User_Short_Profile');
}