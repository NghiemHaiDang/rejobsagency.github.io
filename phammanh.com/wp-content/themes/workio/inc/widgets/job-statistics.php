...
class Workio_Widget_Job_Statistics extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_job_statistics',
            esc_html__('Job Detail:: Statistics', 'workio'),
            array( 'description' => esc_html__( 'Show job statistics', 'workio' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('show_post_date') ); ?>">
                <?php esc_html_e('Show post date', 'workio'); ?>
            </label>
        </p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('show_views') ); ?>">
                <?php esc_html_e('Show Views', 'workio'); ?>
            </label>
        </p>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_name('show_applicants') ); ?>">
                <?php esc_html_e('Show Applicants', 'workio'); ?>
            </label>
        </p>
...
if ( function_exists('apus_framework_reg_widget') ) {
    apus_framework_reg_widget('Workio_Widget_Job_Statistics');
}