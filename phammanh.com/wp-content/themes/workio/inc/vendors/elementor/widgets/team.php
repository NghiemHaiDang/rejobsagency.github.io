...
class Workio_Elementor_Team extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Apus Teams', 'workio' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'name', [
                'label' => esc_html__( 'Member Name', 'workio' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Member Name' , 'workio' ),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'description',
            [
                'label' => esc_html__( 'Member Description', 'workio' ),
        ...
        $this->add_control(
            'job', [
                'label' => esc_html__( 'Member Job', 'workio' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'Member Job' , 'workio' ),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'name' => 'image',
                'label' => esc_html__( 'Image', 'workio' ),
                'type' => Controls_Manager::MEDIA,
                'placeholder'   => esc_html__( 'Upload Image Here', 'workio' ),
            ]
        );
        ...
        $this->add_responsive_control(
            'box_border_radius',            
            [
                'label' => esc_html__( 'Box Radius', 'workio' ),                 
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%' ],
                'selectors' => [                                        
                    '{{WRAPPER}} .widget-team' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',                    
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .widget-team' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [                
                ...
                'selectors' => [                    
                    '{{WRAPPER}} .widget-team' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            'job_bg_color',
            [                
                'label' => esc_html__( 'Job Background', 'workio' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [                    
                    '{{WRAPPER}} .widget-team' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .widget-team .team-description',                
            ]
        );
    ...
    protected function render() {
        ...
        ?>
        <div class="widget widget-team <?php echo esc_attr($el_class.' '.$alignment); ?>">
            <div class="team-item">
                <div class="top-image">
                    <?php
                    ...
                    ?>
                        <div class="team-image">
                            <?php echo workio_get_attachment_thumbnail($settings['img_src']['id'], 'full'); ?>
                        </div>
                    <?php } ?>
                </div>
            </div>
            <div class="content">
                ...
                <?php if ( !empty($description) ) { ?>
                    <div class="team-description"><?php echo esc_html($description); ?></div>
                <?php } ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new Workio_Elementor_Team );