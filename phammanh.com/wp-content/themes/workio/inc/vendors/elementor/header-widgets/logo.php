...
class Workio_Elementor_Logo extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Header Logo', 'workio' );
    }
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            'image',
            [
                'label' => esc_html__( 'Main Logo', 'workio' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new Workio_Elementor_Logo );