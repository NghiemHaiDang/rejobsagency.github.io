...
class Workio_Elementor_Job_Board_Category_List extends Elementor\Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Category List', 'workio' );
    }
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Category List', 'workio' ),
                        ...
                        <div class="row">
                            <div class="catgory-parent col-md-3 col-xs-12">
                                <a href="<?php echo esc_url(get_term_link( $term, 'job_listing_category' )); ?>">
                                    ...
                                    ?>
                                        <div class="number_total">(<?php echo sprintf(_n('<span>%d</span> Job', '<span>%d</span> Jobs', $count, 'workio'), $number_jobs); ?>)</div>
                                    <?php } ?>
                                </a>
                            </div>
                                                    ...
                                                    <li>
                                                        <a href="<?php echo esc_url(get_term_link( $term, 'job_listing_category' )); ?>">
                                                            ...
                                                            <?php if ( $show_nb_jobs ) {
                                                                ...
                                                                $number_jobs = $number_jobs ? WP_Job_Board_Mixes::format_number($number_jobs) : 0;
                                                            ?>
                                                                <span class="number"> (<?php echo sprintf(_n('<span>%d</span> Job', '<span>%d</span> Jobs', $count, 'workio'), $number_jobs); ?>)</span>
                                                            <?php } ?>
                                                            </div>
                                                        </a>
                                                    </li>
...
Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Workio_Elementor_Job_Board_Category_List );