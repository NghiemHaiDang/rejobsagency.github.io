...
class Workio_Elementor_Job_Board_Candidate_Search_Form extends Elementor\Widget_Base {

	public function get_name() {
        return 'apus_element_job_board_candidate_search_form';
    }

	public function get_title() {
        return esc_html__( 'Apus Candidates Search Form', 'workio' );
    }
    ...
    public function get_form_fields() {
        ...
        return array(
            ...
            'category' => array(
                'label' => esc_html__( 'Candidate Category', 'workio' ),
	...
	protected function _register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [                                        
                    '{{WRAPPER}} .search-form-inner .form-group-inner .form-control,{{WRAPPER}} .search-form-inner .form-group-inner .select2-selection--single' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;',                    
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [                                        
                    '{{WRAPPER}} .search-form-inner .action-location .find-me' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .search-form-inner .form-control' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .search-form-inner .form-control::placeholder' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .search-form-inner .form-control::-webkit-input-placeholder' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .search-form-inner .form-control::-moz-placeholder' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .search-form-inner .form-control:-ms-input-placeholder' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .search-form-inner .form-control:-moz-placeholder' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .search-form-inner .select2-selection__placeholder' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .search-form-inner .select2-selection--single' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .search-form-inner .select2-selection__rendered' => 'color: {{VALUE}};',
                ],
            ]
        );
	...
	protected function render() {
        ...
        ?>
        <div class="widget-job-search-form widget-candidate-search-form <?php echo esc_attr($el_class.' '.$style); ?>">
            <?php if ( !empty($title) ) { ?>
                <h1 class="title">
...
Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Workio_Elementor_Job_Board_Candidate_Search_Form );