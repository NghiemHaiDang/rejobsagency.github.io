	...
	<div class="row flex-middle-sm">
			...
			<div class="wrapper-image">
				...
				<?php if (workio_get_config('show_quickview', false)) { ?>
		            <a href="#" class="quickview" data-product_id="<?php echo esc_attr($product_id); ?>" data-toggle="modal" data-target="#apus-quickview-modal">
		                <?php echo esc_html('quick view','workio'); ?>
		            </a>
		        <?php } ?>
			    <figure class="image">
			        ...
			        <?php do_action('workio_woocommerce_before_shop_loop_item'); ?>
			    </figure>
			</div> 
		</div>
		<div class="col-xs-7 col-sm-5 col-lg-6">
		    <div class="wrapper-info">
	            ...
	            <div class="product-excerpt">
		           <?php echo workio_substring( get_the_excerpt(), 50, '...' ); ?>
		        </div>
			</div>
		</div> 
		<div class="col-xs-12 col-sm-4 col-lg-3">
			<div class="left-infor">
				<?php 
					do_action('workio_list_shipping_info');
					add_action( 'workio_list_price', 'woocommerce_template_loop_price', 10 );
					do_action('workio_list_price');
				?>
