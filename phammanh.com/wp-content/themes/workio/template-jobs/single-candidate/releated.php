...
$relate_columns = workio_get_config('candidate_releated_columns', 3);
if ($terms) {
    $termids = array();
...
?>
    <div class="releated-candidates">
        <div class="flex-middle top-info">
            <h4 class="title">
                <?php esc_html_e( 'Related Candidates', 'workio' ); ?>
            </h4>
            <div class="ali-right">
                <a href="<?php echo WP_Job_Board_Mixes::get_candidates_page_url(); ?>" class="view_all">
