            ...
            <div class="flex-middle-sm inner-left">
                ...
                <div class="ali-right visible-lg">
                        <div class="applicant-action-button">
                            ...
                            if ( $download_url ) {
                            ?>
                                <a data-toggle="tooltip" href="<?php echo esc_url($download_url); ?>" title="<?php esc_attr_e('Download CV', 'workio'); ?>" class="btn-action-icon download"><i class="ti-download"></i></a>
                            <?php } ?>
                            <a data-toggle="tooltip" href="<?php echo esc_url( $candidate_url ); ?>" class="btn-action-icon view" rel="bookmark" title="<?php esc_attr_e('View Profile', 'workio'); ?>"><i class="ti-eye"></i></a>
                            ...
                            ?>
                            <a data-toggle="tooltip" href="javascript:void(0);" class="btn-approve-job-applied btn-action-icon approve  <?php echo esc_attr($classes); ?>" data-applicant_id="<?php echo esc_attr($post->ID); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce( 'wp-job-board-approve-applied-nonce' )); ?>" title="<?php echo esc_attr_e('Approve Application', 'workio'); ?>"><i class="ti-check"></i></a>

                            <a data-toggle="tooltip" title="<?php esc_attr_e('Reject', 'workio'); ?>" href="javascript:void(0);" class="btn-action-icon btn-reject-job-applied <?php echo esc_attr($classes); ?> rejec reject" data-applicant_id="<?php echo esc_attr($post->ID); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce( 'wp-job-board-reject-applied-nonce' )); ?>"><i class="ti-loop"></i></a>
