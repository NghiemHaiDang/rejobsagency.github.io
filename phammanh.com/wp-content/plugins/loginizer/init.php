...
define('LOGINIZER_VERSION', '1.6.2');
...
$site_name';
	...
	//$loginizer['passwordless_html'] = empty($options['passwordless_html']) ? $loginizer['passwordless_html'] : $options['passwordless_html'];
	$loginizer['passwordless_html'] = '';
