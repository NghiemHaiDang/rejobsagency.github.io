...
<div class="apus-social-share">
		...
		<span class="title"><?php echo esc_html__('Share:','workio'); ?> </span>
		

		<?php if ( workio_get_config('facebook_share', 1) ): ?>
		...
		<?php endif; ?>
		<?php if ( workio_get_config('twitter_share', 1) ): ?>
		...
		<?php endif; ?>
		<?php if ( workio_get_config('linkedin_share', 1) ): ?>
		...
		<?php if ( workio_get_config('pinterest_share', 1) ): ?>
		...
		<?php if ( workio_get_config('more_share', 1) ): ?>
