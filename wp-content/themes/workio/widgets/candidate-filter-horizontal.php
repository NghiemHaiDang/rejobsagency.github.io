...
?>
<div class="widget-filter-candidate-top widget-filter-top">
	<div class="container">
		<?php 
		...
		?>
		<form method="get" action="<?php echo WP_Job_Board_Mixes::get_candidates_page_url(); ?>" class="filter-candidate-form filter-listing-form filter-candidate-top">
			<?php $fields = $fields_adv = workio_candidate_get_filter_fields(); ?>
						...
						<div class="flex-middle space-bottom-15">
							<?php if ( ! empty( $instance['button_text'] ) ) : ?>
								<div class="visiable-line">
									<button class="button btn btn-theme-second"><?php //echo esc_attr( $instance['button_text'] ); ?>Bộ lọc</button>
								</div><!-- /.form-group -->
							<?php endif; ?>
