...
<div class="reply-message-form-wrapper">
	<form id="reply-message-form" class="reply-message-form" action="?" method="post">
        ...
        <div class="form-group space-30">
            <textarea class="form-control" name="message" placeholder="<?php esc_attr_e( 'Write your message...', 'workio' ); ?>" required="required"></textarea>
        </div><!-- /.form-group -->

        <button class="button btn reply-message-btn"><i class="fa fa-paper-plane"></i></button>
