                ...
                <div class="ali-right visible-lg">
                    <div class="flex-middle">
                        <div class="applicant-action-button">
                            ...
                            <a data-toggle="tooltip" title="<?php esc_attr_e('Undo Rejected', 'workio'); ?>" href="javascript:void(0);" class="btn-undo-reject-job-applied btn-action-icon rejec reject" data-applicant_id="<?php echo esc_attr($post->ID); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce( 'wp-job-board-undo-reject-applied-nonce' )); ?>"><i class="fa fa-undo"></i></a>
