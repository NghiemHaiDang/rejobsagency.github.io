...
?>
    <div id="job-employer-portfolio" class="employer-detail-portfolio">
    	<h4 class="title"><?php esc_html_e('Team Member', 'workio'); ?></h4>
		            ...
		            <div class="member-item">
		            	<div class="profile-image">
			            	<?php if ( !empty($member['profile_image']) ) { ?>
			            		<div class="image">
				                	<img src="<?php echo esc_url($member['profile_image']); ?>" alt="<?php esc_attr_e('Image', 'workio'); ?>">
				                </div>
				            <?php } ?>
				        ...
				        <div class="content">
				            ...
				            <?php if ( !empty($member['experience']) ) { ?>
			            		<div class="experience text-theme"><?php esc_html_e('Experience: ', 'workio'); ?><?php echo esc_html($member['experience']); ?></div>
				            <?php } ?>
			            </div>
		            </div>
	            </div>
