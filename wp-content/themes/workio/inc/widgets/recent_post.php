...
class Workio_Recent_Post extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_recent_post',
            esc_html__('Apus Recent Posts Widget', 'workio'),
            array( 'description' => esc_html__( 'Show list of recent post', 'workio' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('post_type')); ?>">
                <?php echo esc_html__('Type:', 'workio' ); ?>
            </label>
            <br>
...
if ( function_exists('apus_framework_reg_widget') ) {
    apus_framework_reg_widget('Workio_Recent_Post');
}