...
class Workio_Socials_Widget extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_socials_widget',
            esc_html__('Apus Socials', 'workio'),
            array( 'description' => esc_html__( 'Socials for website.', 'workio' ), )
        );
    ...
    public function scripts() {
        wp_enqueue_script( 'workio-admin', get_template_directory_uri().'/js/admin.js', array( 'jquery' ), '1.0', true );
    }
    ...
    public function form( $instance ) {
        ...
        $styles = array(
            esc_html__('Style 1', 'workio') => 'style1',
            esc_html__('Style 2', 'workio') => 'style2'
        );
    ...
    <div class="apus_socials">
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'socials' )); ?>"><?php esc_html_e('Select socials:', 'workio'); ?></label>
            <br>
        <?php
        ...
        ?>
         ...
         <p>
            <label for="<?php echo esc_attr($this->get_field_id('styles')); ?>">
                <?php echo esc_html__('Style:', 'workio' ); ?>
            </label>
            <br>
...
if ( function_exists('apus_framework_reg_widget') ) {
    apus_framework_reg_widget('Workio_Socials_Widget');
}