...
class Workio_Elementor_Job_Board_Jobs extends Elementor\Widget_Base {

	public function get_name() {
        return 'apus_element_job_board_jobs';
    }

	public function get_title() {
        return esc_html__( 'Apus Jobs', 'workio' );
    }
	...
	protected function _register_controls() {
        ...
        $this->add_control(
            'type_slugs',
            [
                'label' => esc_html__( 'Types Slug', 'workio' ),
                'type' => Elementor\Controls_Manager::TEXTAREA,
                'rows' => 2,
                'default' => '',
                'placeholder' => esc_html__( 'Enter id spearate by comma(,)', 'workio' ),
        ...
        $this->add_control(
            'get_jobs_by',
            [
                'label' => esc_html__( 'Get Jobs By', 'workio' ),
                'type' => Elementor\Controls_Manager::SELECT,
                'options' => array(
        ...
        $this->add_control(
            'job_item_style',
            [
                'label' => esc_html__( 'Job Item Style', 'workio' ),
                'type' => Elementor\Controls_Manager::SELECT,
                'options' => array(
                    'list' => esc_html__('List', 'workio'),
                    'grid' => esc_html__('Grid - Box Shadow', 'workio'),
                    'grid-v1' => esc_html__('Grid - Border', 'workio'),
                ),
                'default' => 'grid-v1'
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Elementor\Controls_Manager::TEXT,
                'input_type' => 'text',
                'default' => 'Load More Job Opportunity',
                'condition' => [
                    'view_all' => ['yes'],
                ]
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [                    
                    '{{WRAPPER}} .job-title a' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
        ...
        $this->add_control(
            ...
            [                
                ...
                'type' => Elementor\Controls_Manager::COLOR,
                'selectors' => [                    
                    '{{WRAPPER}} .job-grid' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .job-list' => 'color: {{VALUE}};',
                ],
            ]
        );
...
Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Workio_Elementor_Job_Board_Jobs );