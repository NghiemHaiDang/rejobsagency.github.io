...
class Workio_Elementor_Job_Board_Employers extends Elementor\Widget_Base {

	public function get_name() {
        return 'apus_element_job_board_employers';
    }

	public function get_title() {
        return esc_html__( 'Apus Employers', 'workio' );
    }
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Employers', 'workio' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'input_type' => 'number',
                'description' => esc_html__( 'Limit employer to display', 'workio' ),
                'default' => 3,
                'description' => 'Note: 3 column is Awesome'
            ]
        );
        ...
        $this->add_control(
            'get_employers_by',
            [
                'label' => esc_html__( 'Get Employers By', 'workio' ),
                'type' => Elementor\Controls_Manager::SELECT,
                'options' => array(
                    'default' => esc_html__('Default', 'workio'),
                    'featured' => esc_html__('Featured Employers', 'workio'),
                    'recent' => esc_html__('Recent Employers', 'workio'),
                ),
                'default' => 'recent'
            ]
        );
        ...
        $this->add_control(
            'employer_title_color',
            [
                'label' => esc_html__( 'Job Title', 'workio' ),
        ...
        $this->add_control(
            'employer_description_color',
            [                
                'label' => esc_html__( 'Description', 'workio' ),
                'type' => Elementor\Controls_Manager::COLOR,
                'selectors' => [                    
                    '{{WRAPPER}} .employer-style-inner' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .employer-style-inner .job-category a' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .employer-style-inner .employer-metas' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .employer-style-inner .employer-metas .open-job' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .employer-style-inner .employer-metas span' => 'color: {{VALUE}};',                    
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'label' => esc_html__( 'Employer Title', 'workio' ),
                'name' => 'title_employer_typography',
                'selector' => '{{WRAPPER}} .employer-title',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .employer-style-inner',
            ]
        );        
	...
	protected function render() {
        ...
        $loop = workio_get_employers($args);
        if ( $loop->have_posts() ) {
            ?>
...
Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Workio_Elementor_Job_Board_Employers );