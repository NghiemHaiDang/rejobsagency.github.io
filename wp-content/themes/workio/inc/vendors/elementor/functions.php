...
if( ! class_exists( 'Workio_Elementor_Extensions' ) ) {
    final class Workio_Elementor_Extensions {
        ...
        public function __construct() {
            ...
            add_filter( 'workio_generate_post_builder', array( $this, 'render_post_builder' ), 10, 2 );
        ...
        public function add_widget_categories( $elements_manager ) {
            $elements_manager->add_category(
                'workio-elements',
                [
                    'title' => esc_html__( 'Workio Elements', 'workio' ),
                    'icon' => 'fa fa-shopping-bag',
                ]
            );

            $elements_manager->add_category(
                'workio-header-elements',
                [
                    'title' => esc_html__( 'Workio Header Elements', 'workio' ),
                    'icon' => 'fa fa-shopping-bag',
                ]
            );
        ...
        public function elementor_widgets() {
            ...
            if ( workio_is_mailchimp_activated() ) {
                get_template_part( 'inc/vendors/elementor/widgets/mailchimp' );
            }
            
            if ( workio_is_revslider_activated() ) {
            ...
            if ( workio_is_wp_job_board_activated() ) {
                ...
                get_template_part( 'inc/vendors/elementor/wp-job-board-widgets/job_search_form' );
        ...
        public function style() {
            wp_enqueue_style('workio-flaticon',  get_template_directory_uri() . '/css/flaticon.css');
            wp_enqueue_style('workio-et-line',  get_template_directory_uri() . '/css/et-line.css');
        ...
        public function modify_controls( $controls_registry ) {
            ...
            $new_icons = array_merge(
                array(
                    ...
                    'flaticon-find-my-friend' => 'flaticon-find-my-friend',
                    ...
                    'flaticon-android-logo' => 'flaticon-android-logo',
                    'flaticon-apple' => 'flaticon-apple',
                    'flaticon-account' => 'flaticon-account',
                    'flaticon-save-money' => 'flaticon-save-money',
                    'flaticon-back-in-time' => 'flaticon-back-in-time',
                    'flaticon-gender-equality' => 'flaticon-gender-equality',
                    'flaticon-achievement' => 'flaticon-achievement',
                    'flaticon-reaction' => 'flaticon-reaction',
                    'flaticon-marketing' => 'flaticon-marketing',
                    'flaticon-policy' => 'flaticon-policy',
                    'flaticon-adjust' => 'flaticon-adjust',
                    'flaticon-businessman-paper-of-the-application-for-a-job' => 'flaticon-businessman-paper-of-the-application-for-a-job',
                    ...
                    'flaticon-www' => 'flaticon-www',
                    'flaticon-calendar' => 'flaticon-calendar',
                    'flaticon-visibility' => 'flaticon-visibility',
                    'flaticon-birthday' => 'flaticon-birthday',
                    'flaticon-community' => 'flaticon-community',
                    'flaticon-manual' => 'flaticon-manual',
                    'flaticon-curriculum-vitae' => 'flaticon-curriculum-vitae',
                    'flaticon-document' => 'flaticon-document',
                    'flaticon-document-1' => 'flaticon-document-1',
                    "icon-bargraph" => "icon-bargraph",
                    "icon-tools-2" => "icon-tools-2",
                    ...
                    "icon-profile-male" => "icon-profile-male",      
...
if ( did_action( 'elementor/loaded' ) ) {
    ...
    Workio_Elementor_Extensions::instance();
}