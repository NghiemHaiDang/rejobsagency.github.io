...
class Workio_Elementor_Instagram extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Instagram', 'workio' );
    }
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Instagram', 'workio' ),
        ...
        $this->add_control(
            'username',
            [
                'label' => esc_html__( 'Instagram Username', 'workio' ),
                'type' => Controls_Manager::TEXT,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => esc_html__( 'Number images to display', 'workio' ),
                'default' => 4
            ]
        );
        ...
        $this->add_control(
            'size',
            [
                'label' => esc_html__( 'Photo size', 'workio' ),
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    'thumbnail' => esc_html__('Thumbnail', 'workio'),
                    'small' => esc_html__('Small', 'workio'),
                    'large' => esc_html__('Large', 'workio'),
                    'original' => esc_html__('Original', 'workio'),
                ),
                'default' => 'thumbnail'
            ]
        );
        ...
        $this->add_control(
            'target',
            [
                'label' => esc_html__( 'Open links in', 'workio' ),
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    '_self' => esc_html__('Current window (_self)', 'workio'),
                    '_blank' => esc_html__('New window (_blank)', 'workio'),
                ),
                'default' => 'grid'
            ]
        );
                ...
                <?php
                    ...
                    if ( $username != '' ) {
                        ...
                        if ( is_wp_error( $media_array ) ) {
                            ...
                            if ( $images_only = apply_filters( 'workio_instagram_element_images_only', false ) ) {
...
Plugin::instance()->widgets_manager->register_widget_type( new Workio_Elementor_Instagram );