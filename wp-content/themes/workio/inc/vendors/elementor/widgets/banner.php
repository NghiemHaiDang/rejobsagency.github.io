...
class Workio_Elementor_Banner extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Banner', 'workio' );
    }
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Banner', 'workio' ),
        ...
        $this->add_responsive_control(
            'content_align',
            [
                'label' => esc_html__( 'Content Alignment', 'workio' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'left' => [
                        'title' => esc_html__( 'Left', 'workio' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => array(
                    ...
                    'style3' => esc_html__('Style 3', 'workio'),
                    'style4' => esc_html__('Style 4', 'workio'),
                ),
                'default' => 'style1'
            ]
        );
        $this->add_control(
            'vertical',
            [
                'label' => esc_html__( 'Vertical Content', 'workio' ),
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    'flex-top' => esc_html__('Top', 'workio'),
                    'flex-middle' => esc_html__('Middle', 'workio'),
                    'flex-bottom' => esc_html__('Bottom', 'workio'),
                ),
                'default' => 'flex-middle'
            ]
        );
...
Plugin::instance()->widgets_manager->register_widget_type( new Workio_Elementor_Banner );