...
class Workio_Elementor_Nav_Menu extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Navigation Menu', 'workio' );
    }
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Navigation Menu', 'workio' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => array(
                    ...
                    'inline' => esc_html__('In Line', 'workio'),
                ),
                'default' => ''
            ]
        );
        ...
        $this->start_controls_section(
            'section_menu_style',
            [
                'label' => esc_html__( 'Menu Item', 'workio' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'menu_color',
            [
                'label' => esc_html__( 'Menu Color', 'workio' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'menu_color_hover',
            [
                'label' => esc_html__( 'Menu Color Hover', 'workio' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    // Stronger selector to avoid section style from overwriting
        ...
        $this->add_group_control(
            Group_Control_Typography::get_type(),
            [
                'label' => esc_html__( 'Menu Typography', 'workio' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new Workio_Elementor_Nav_Menu );