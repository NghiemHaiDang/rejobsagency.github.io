...
class Workio_Elementor_Achievements extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Achievements', 'workio' );
    }
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Achievements', 'workio' ),
        ...
        $this->add_group_control(
            ...
            [
                'label' => esc_html__( 'Icon Typography', 'workio' ),
            ...
            <?php if ( $image_icon == 'image' ) { ?>
                <?php if ( !empty($image_icon['id']) ) { ?>
                    <div class="inner-left">
                        <?php echo workio_get_attachment_thumbnail($image_icon['id'], 'full'); ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new Workio_Elementor_Achievements );